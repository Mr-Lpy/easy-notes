    ...
    <div id="notes-list">
            ...
            <div class="btn-group btn-group-justified" role="group">
                ...
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-default" @click="show='favorites'"
                            :class="{active:show==='favorites'}">我的收藏
                    </button>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="list-group">
                <transition-group name="el-zoom-in-top" tag="ul" class="trans">
                    <a v-for="note in filteredNotes" class="list-group-item" href="#"
                       :class="{active:activeNote === note}" @click="updateActiveNote(note)" :key="note">
